...
void passOne(std::vector<std::string>& input, std::unique_ptr<OpTable>& opTable, std::unique_ptr<SymTable>& symTable) {
    ...
    while (currentOpcode != "END" && lineIter < input.size()) {
        ...
        if (currentOpcode[0] == '+') {
            ...
            std::cout << "LTORG code goes here \n";
        }else if (currentOpcode == "EQU") {
            std::cout << "EQU code goes here \n";
        }else if (currentOpcode == "EXTDEF") {
            std::cout << "EXTDEF code goes here \n";
        }else if (currentOpcode == "USE") {
            std::cout << "USE code goes here \n";
        }else if (currentOpcode == "MACRO") {
            std::cout << "MACRO code goes here \n";
        }else if (currentOpcode == "MEND") {
            std::cout << "MEND code goes here \n";
        }
        else {
